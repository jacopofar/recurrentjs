...
/*  if (typeof R === 'undefined' && typeof require !== 'undefined') {
    R = require('./recurrent.js');
  }*/
  ...
  this.predictSentence = function (samplei, temperature, letterToIndex, indexToLetter) {
  ...
  this.costfun = function (sent, letterToIndex) {
    ...
    for (var i = -1; i < n; i++) {
      ...
      let lh = this.forwardIndex(G, ix_source, prev);
      prev = lh;
